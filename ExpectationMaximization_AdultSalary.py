...
#function definition
def GM(X_train, X_test, y_train, y_test, no_iter = 300, component_list =[2,4,6,8,10,12], num_class = 14):
...
#function call
GM(X_train, X_test, y_train, y_test, component_list = [2,4,6,8,12,14], num_class = 14)
...
PCA_data = PCA(n_components = 14,whiten=False)
...
GM(PCA_data_trans, PCA_data_trans_test, y_train, y_test, component_list = [2,4,6,8,12,14], num_class = 14)
...
GM(ICA_data_trans, ICA_data_trans_test, y_train, y_test, component_list = [2,4,6,8,10,12], num_class = 14)
...
GM(LDA_data_trans, LDA_data_trans_test, y_train, y_test, component_list = [2,4,6,8,12,14], num_class = 14)
